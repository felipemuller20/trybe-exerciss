...
CREATE TABLE `cuidador` (
  `cuidadorID` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(50) DEFAULT NULL,
  `gerenteID` int DEFAULT NULL,
  PRIMARY KEY (`cuidadorID`),
  KEY `gerenteID` (`gerenteID`),
  CONSTRAINT `cuidador_ibfk_1` FOREIGN KEY (`gerenteID`) REFERENCES `gerente` (`gerenteID`)
...
-- Dump completed on 2021-08-03 15:37:43
